            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative perspective-1000">
                    <motion.div
                        ...
                        className="relative bg-[#f0f4f9] p-4 md:p-8 rounded-[40px] shadow-2xl border border-gray-100 aspect-square flex items-center justify-center overflow-hidden"
                        style={{ transformStyle: "preserve-3d" }}
                    >
                        <div className="absolute top-8 left-8 bg-google-red text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg z-20 flex items-center gap-2">
                            <span className="w-2 h-2 rounded-full bg-white animate-pulse" />
                            LIVE STREAMING
                        </div>

                        <div className="w-full h-full rounded-3xl overflow-hidden relative border border-gray-200/50 bg-white shadow-inner flex items-center justify-center">
                            <video
                                src="/kira.mp4"
                                autoPlay
                                loop
                    ...
                    <div className="absolute -bottom-6 left-10 flex gap-4 z-20">
                        <motion.div initial={{ y: 20 }} whileInView={{ y: 0 }} transition={{ delay: 0.2 }} className="bg-white px-4 py-2 rounded-full shadow-lg border border-gray-100 text-sm font-[300] text-gray-800 flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-google-blue" />Voice</motion.div>
                        <motion.div initial={{ y: 20 }} whileInView={{ y: 0 }} transition={{ delay: 0.3 }} className="bg-white px-4 py-2 rounded-full shadow-lg border border-gray-100 text-sm font-[300] text-gray-800 flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-google-green" />Vision</motion.div>
                        <motion.div initial={{ y: 20 }} whileInView={{ y: 0 }} transition={{ delay: 0.4 }} className="bg-white px-4 py-2 rounded-full shadow-lg border border-gray-100 text-sm font-[300] text-gray-800 flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-google-yellow" />Functions</motion.div>
                    </div>
                </div>

                {/* Right Side: Data Flow Diagram */}
                <div>
                    <h2 className="text-4xl font-[300] text-gray-900 mb-6">Powered by Gemini 2.0</h2>
